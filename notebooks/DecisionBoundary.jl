...
# ╔═╡ 15f47da0-f558-11ec-1fef-ef2793530bf7
using Plots, Statistics, LinearAlgebra, PlutoUI

# ╔═╡ 5c3bafe4-e3a5-42da-b78e-9bdd63e7ea06
TableOfContents()

# ╔═╡ a12ce7f9-4cfe-488b-89da-cf53ec6f233f
md"## Dataset"

# ╔═╡ 60880549-1914-417e-a9bc-d7206280ebcb
begin
	X_vals = [[0.5, 1.5], [1,1], [1.5, 0.5], [3, 0.5], [2, 2], [1, 2.5]]
	X = reduce(hcat, X_vals)
	y = [0, 0, 0, 1, 1, 1]
end

# ╔═╡ 76a3dc30-1b68-4175-969c-c42e6b80b818
prod(X, dims=1)

# ╔═╡ f329c534-c383-4d76-befe-16c7cebaf564
X

# ╔═╡ 0e423093-b211-41eb-9db0-8fe0fe5bcbc4
begin
...
# ╔═╡ 62e44615-a870-4b73-915c-195ddcf4ec1b
md"## Logistic regression model"

# ╔═╡ c990ce23-b3b3-48de-abe2-b30adfa3e63c
sigmoid(z) = 1.0 ./ (1.0 .+ exp.(-z))

# ╔═╡ 52264c6e-e89d-4777-ba60-1ee5c47cf25e
begin
	z = -10:10
	plot(z, sigmoid(z))
	vline!([0])
...
# ╔═╡ 5e9dbfc0-322b-4dde-afdc-5621966f7085
begin
	x0 = 0:6
	x1 = 3 .- x0
	plot(x0, x1, fill = (-3, 0.2, :blue), lims=(0, 4))
	scatter!(X[1,m1], X[2,m1], xaxis=("x₁"), yaxis=("x₂"), markercolor=:red, label="y=1")
	scatter!(X[1,m2], X[2,m2], xaxis=("x₁"), yaxis=("x₂"), markercolor=:blue, label="y=0" )
end
