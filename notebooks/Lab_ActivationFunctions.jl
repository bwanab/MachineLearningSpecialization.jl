...
# ╔═╡ 684a8922-fb03-11ec-25d4-53b9d8f4ef90
using Flux,Plots

# ╔═╡ 51509d18-1efa-48ed-92fc-2165b9de5864
begin
	p1 = plot(relu, title="relu")
	p2 = plot(-5:5, -5:5, title="linear")
	p3 = plot(sigmoid, title="sigmoid")
	plot(p1, p2, p3, size=(700, 500))
end
