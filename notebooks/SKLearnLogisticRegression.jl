...
# ╔═╡ a68c6a28-f62d-11ec-2396-bfef2879f9af
using ScikitLearn

# ╔═╡ fac048ac-ca1d-4ba9-a829-dad6cd1fac1e
@sk_import linear_model: LogisticRegression

# ╔═╡ 7b8fecc6-c109-4048-b45d-dbfb693b95bb
X_train = reduce(hcat, [[0.5, 1.5], [1,1], [1.5, 0.5], [3, 0.5], [2, 2], [1, 2.5]])'

# ╔═╡ 18e78ca5-7e03-43d6-8ff0-b1f3deedfbb7
y_train = [0,0,0,1,1,1]

# ╔═╡ 72065147-c52f-4ae9-ae40-5445d03b4dbc
model = LogisticRegression()

# ╔═╡ b0a604ee-cea5-4135-b85e-57647fba9cbb
model.fit(X_train, y_train)

# ╔═╡ bbe6fed9-685c-4a60-bc25-34710446e3f5
pred = model.predict(X_train)

# ╔═╡ 0eb3ab17-d47e-45ee-bc2a-16c2ad22a05d
